...
def llama3_flash_attn_varlen_forward(
    ...
    async_handles.register(lambda: dist.all_gather_into_tensor(kv_buffer_copy[0], k_0, group=process_group))
    async_handles.register(lambda: dist.all_gather_into_tensor(kv_buffer_copy[1], v_0, group=process_group))
    ...
    for i in range(0, nheads_k, heads_k_stride):
        ...
        if i < nheads_k - heads_k_stride:
            ...
            async_handles.register(lambda: dist.all_gather_into_tensor(kv_buffer_copy[0], send_k, group=process_group))
            async_handles.register(lambda: dist.all_gather_into_tensor(kv_buffer_copy[1], send_v, group=process_group))
